...
[![Demo video](https://img.shields.io/badge/video-60s%20walkthrough-blue)](docs/demo/briefed-demo.webm)
...
[![Watch the 60-second Briefed product walkthrough](docs/demo/briefed-demo-poster.png)](docs/demo/briefed-demo.webm)

**[▶ Watch the 60-second product walkthrough](docs/demo/briefed-demo.webm)** — recorded with Playwright against a synthetic demo inbox, so it shows the real UI and flows without exposing private email data.
