...
Personal AI email agent. Stack: Python · FastAPI · Pydantic · Gemini 1.5 Flash (primary) · Codex Haiku 4.5 (fallback) · Gmail API · Supabase · React · PWA · AWS Lambda + SnapStart · Terraform.
